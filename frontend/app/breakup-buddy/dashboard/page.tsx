  ...
  return (
    <div className="min-h-screen bg-[#0b111e] text-white p-8">
      <div className="max-w-4xl mx-auto bg-[#131d2e] border border-white/10 rounded-2xl p-8">
        <h1 className="text-2xl font-bold mb-2">Breakup Buddy & Community Portal</h1>
        <p className="text-slate-400 mb-6">Empathetic support, peer circles, and positive closure spaces.</p>
